// Node02 (server) to serve from branch node and send to master
#include <RF24.h>
...
int failed_send_to_branch_stack = 0;
...
void loop()
{
    ...
    if (network.available())
    {
        ...
        if (header.from_node == node_client_04)
        {
            ReadSendClientMultiHop(node_client_04, headerToSend);
        }
    }
